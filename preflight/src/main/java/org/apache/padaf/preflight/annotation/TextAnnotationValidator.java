...
argument_list|)
decl_stmt|;
comment|// ---- For Text Annotation, this two flags should be set to avoid potential
comment|// ambiguity between the annotation dictionary and the reader behavior.
name|result
operator|=
name|result
operator|&&
