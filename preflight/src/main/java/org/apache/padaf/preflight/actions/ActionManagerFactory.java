...
block|{
comment|//	/**
comment|//	 * This map is used to know if an Action has already been validated. It is
comment|//	 * useful to avoid infinite loop in an action which has a Next entry.
comment|//	 */
comment|//	private Map<COSObjectKey, Boolean> alreadyCreated = new HashMap<COSObjectKey, Boolean>();
...
return|;
block|}
comment|/** 	 * Create an instance of ActionManager according to the value of the S entry. 	 * If the type entry isn't Action, a ValidationException will be thrown. 	 *  	 * If the action type isn't authorized in a PDF/A file, an instance of 	 * InvalidAction is returned. 	 *  	 * @param action 	 *          the action dictionary used to instantiate the ActionManager 	 * @param cDoc 	 *          the COSDocument which contains the action 	 * @param isAA 	 *          the Action identifier if it is an additional action 	 * @return 	 * @throws ValidationException 	 */
specifier|protected
name|AbstractActionManager
name|createActionManager
parameter_list|(
