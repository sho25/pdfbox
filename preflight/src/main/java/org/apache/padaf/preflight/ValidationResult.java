...
argument_list|()
decl_stmt|;
comment|/** 	 * Object representation of the PDF file. 	 * This object has to be closed explicitly by the user using the 	 * close method of the ValidationResult object or directly by the  	 * close method of the PDDocument object. 	 *  	 * This attribute can be null if the Validation fails during the  	 * validation of the document syntax using the PDFParser object. 	 */
specifier|private
name|PDDocument
name|pdf
init|=
...
return|;
block|}
comment|/** 	 * @param pdf the pdf to set 	 */
name|void
name|setPdf
parameter_list|(
name|PDDocument
...
expr_stmt|;
block|}
comment|/** 	 * Close the instance of PDDocument contained by this  	 * ValidationResult object 	 */
specifier|public
name|void
name|closePdf
parameter_list|()
