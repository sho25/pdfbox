...
return|;
block|}
comment|/** 	 * Extracts and compares first and last trailers for PDF version between 1.1 and 1.4 	 * @param handler 	 * @param result 	 */
specifier|protected
name|void
name|checkTrailersForLinearizedPDF14
parameter_list|(
...
block|}
block|}
comment|/** 	 * Accesses and compares First and Last trailers for a PDF version higher than 1.4. 	 *  	 * @param handler 	 * @param result 	 */
specifier|protected
name|void
name|checkTrailersForLinearizedPDF15
parameter_list|(
