...
return|;
block|}
comment|/**    * The AA field is forbidden for the Widget annotation when the PDF is a    * PDF/A. This method return false and update the errors list if this key is    * present. returns true otherwise    *     * @param errors    * @return    */
specifier|protected
name|boolean
name|checkAAField
parameter_list|(
