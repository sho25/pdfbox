...
argument_list|)
decl_stmt|;
comment|// ---- glyphIdAsString should be a Integer
comment|// TODO OD-PDFA-4 : A vérifier avec un PDF qui contient une stream pour
comment|// CidToGid...
try|try
block|{
name|glyphIndex
...
name|cid
operator|+
literal|" isn't linked with a GlyphIndex>> "
operator|+
name|glyphIdAsString
argument_list|)
decl_stmt|;
