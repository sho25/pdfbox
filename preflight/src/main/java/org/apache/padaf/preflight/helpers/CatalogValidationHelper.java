...
continue|continue;
block|}
comment|// ---- If OutputConditionIdentifier is "Custom" :
comment|// ---- DestOutputProfile and Info are mandatory
comment|// ---- DestOutputProfile must be a ICC Profile
comment|// ---- Because of PDF/A conforming file needs to specify the color
comment|// characteristics, the DestOutputProfile
