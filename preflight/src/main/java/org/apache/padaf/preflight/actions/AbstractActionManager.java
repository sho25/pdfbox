...
literal|null
decl_stmt|;
comment|/**    * The COSDocument from which the action comes from    */
specifier|protected
name|COSDocument
name|cDoc
init|=
...
return|;
block|}
comment|/**    * This method must be implemented by inherited classes to process specific    * validation.    *     * @param error    *          the validation error list to updated if the validation fails.    * @return True if the action is valid, false otherwise.    */
specifier|protected
specifier|abstract
name|boolean
name|innerValid
