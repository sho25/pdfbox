...
block|{
comment|/** 	 * @param handler 	 * @param obj 	 */
specifier|public
name|TrueTypeFontValidator
parameter_list|(
name|DocumentHandler
...
block|}
block|}
comment|/** 	 * This method checks the metric consistency. If the validation fails, the 	 * FontContainer is updated. If the validation is a success, the 	 * FontContainer.cidKnownByFont map is updated. 	 *  	 * @param ttf 	 * @return 	 * @throws IOException 	 */
specifier|protected
name|boolean
name|checkFontMetrics
parameter_list|(
...
block|{
comment|// ---- Returns the MacRomanEncoding CMap
for|for
control|(
name|CMAPEncodingEntry
name|cmapEntry
...
name|ValidationException
argument_list|(
literal|"CMap not found in the TrueType FontProgam"
argument_list|)
throw|;
block|}
block|}
