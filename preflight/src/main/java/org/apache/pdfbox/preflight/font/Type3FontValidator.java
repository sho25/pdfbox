...
expr_stmt|;
block|}
comment|/**      * This method is called by the CheckEncoding method if the Encoding entry is an instance of COSDictionary. In this      * case, a new instance of {@link DictionaryEncoding} is created. If an IOException is thrown by the      * DictionaryEncoding constructor the ERROR_FONTS_ENCODING is pushed in the      * FontContainer.      *       * Differences entry validation is implicitly done by the DictionaryEncoding constructor.      *       * @param fontEncoding      */
specifier|private
name|void
name|checkEncodingAsDictionary
parameter_list|(
