...
expr_stmt|;
block|}
comment|/**      * Add a validation error to the ValidationResult.      *       * @param error the validation error to be added      */
specifier|private
name|void
...
argument_list|()
expr_stmt|;
comment|// Dereference each object to trigger parser validation errors
name|Set
argument_list|<
name|COSObjectKey
argument_list|>
...
return|;
block|}
comment|/**      * Load and validate the given file. Returns the validation result and closes the read pdf.      *       * @param file thew file to be read and validated      * @return the validation result      * @throws IOException in case of a file reading or parsing error      */
specifier|public
specifier|static
name|ValidationResult
name|validate
