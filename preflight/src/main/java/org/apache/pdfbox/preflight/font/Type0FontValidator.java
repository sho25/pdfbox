...
expr_stmt|;
block|}
comment|/**      * Check the content of the CIDSystemInfo dictionary. A CIDSystemInfo dictionary must contain :      *<UL>      *<li>a Name - Registry      *<li>a Name - Ordering      *<li>a Integer - Supplement      *</UL>      *       * @param cidSysInfo      * @return the validation result.      */
specifier|protected
name|boolean
name|checkCIDSystemInfo
parameter_list|(
