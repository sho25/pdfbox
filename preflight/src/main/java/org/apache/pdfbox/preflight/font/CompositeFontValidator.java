...
argument_list|()
decl_stmt|;
comment|// just check if they are present because of the Helper has already checked them.
if|if
condition|(
operator|(
name|type
...
condition|)
block|{
comment|// baseFont syntax isn't checked because of it is a convention not a rule
name|this
operator|.
name|fontContainer
operator|.
...
expr_stmt|;
block|}
comment|/** 	 * Check if all required fields are present in the PDF file to describe the 	 * Font Descriptor. 	 *  	 * @param context 	 * @param fontDescriptor 	 * @param result 	 */
specifier|protected
name|boolean
