...
begin_comment
comment|/**  * This Exception is thrown if an validation error occurs during the javacc validation in the PDF Trailer.  *   * Error codes provided by this exception should start by 1.4 or 1.0.  */
end_comment

begin_class
specifier|public
class|class
name|TrailerParseException
extends|extends
...
name|println
argument_list|(
literal|"## Trailer ParseError"
argument_list|)
expr_stmt|;
block|}
comment|// else Token Management Error or Unknown Error during the Trailer
comment|// Validation
return|return
name|PreflightConstants
operator|.
