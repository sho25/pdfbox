...
literal|null
decl_stmt|;
comment|/**      * The instance of validator      */
specifier|protected
name|PdfAValidator
name|validator
init|=
...
literal|null
decl_stmt|;
comment|/**      * Prepare the test for one file      *       * @param path pdf/a file to test      * @param error expected error for this test      * @throws ValidationException      */
specifier|public
name|AbstractInvalidFileTester
parameter_list|(
name|File
