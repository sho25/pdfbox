...
expr_stmt|;
block|}
comment|/**      * Tests RGB JPEGFactory#createFromImage(PDDocument document, BufferedImage      * image) with color JPEG file      */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * Tests RGB JPEGFactory#createFromImage(PDDocument document, BufferedImage      * image) with gray JPEG file      */
specifier|public
name|void
