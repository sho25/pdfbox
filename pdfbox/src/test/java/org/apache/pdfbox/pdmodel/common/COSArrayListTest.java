...
name|File
argument_list|(
literal|"target/test-output/pdmodel/common"
argument_list|)
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|// create test output directory
name|OUT_DIR
operator|.
name|mkdirs
argument_list|()
...
specifier|public
name|void
name|removeSingleDirectObject
parameter_list|()
throws|throws
name|IOException
block|{
comment|// generate test file
try|try
init|(
name|PDDocument
name|pdf
...
argument_list|()
decl_stmt|;
comment|// enforce the COSDictionaries to be written directly into the COSArray
name|txtMark
operator|.
name|getCOSObject
argument_list|()
...
name|assertTrue
argument_list|(
literal|"There shall be 4 annotations generated"
argument_list|,
name|pageAnnots
operator|.
name|size
...
name|OUT_DIR
operator|+
literal|"/removeSingleDirectObjectTest.pdf"
argument_list|)
expr_stmt|;
name|pdf
operator|.
...
name|assertTrue
argument_list|(
literal|"There shall be 4 annotations retrieved"
argument_list|,
name|annotations
operator|.
name|size
...
name|assertTrue
argument_list|(
literal|"The size of the internal COSArray shall be 4"
argument_list|,
name|annotations
operator|.
name|toList
...
name|assertTrue
argument_list|(
literal|"The size of the internal COSArray shall be 3"
argument_list|,
name|annotations
operator|.
name|toList
...
specifier|public
name|void
name|removeSingleIndirectObject
parameter_list|()
throws|throws
name|IOException
block|{
...
name|OUT_DIR
operator|+
literal|"/removeSingleIndirectObjectTest.pdf"
argument_list|)
expr_stmt|;
name|pdf
operator|.
...
name|OUT_DIR
operator|+
literal|"/removeDirectObjectTest.pdf"
argument_list|)
expr_stmt|;
name|pdf
operator|.
...
name|OUT_DIR
operator|+
literal|"/removeIndirectObjectTest.pdf"
argument_list|)
expr_stmt|;
name|pdf
operator|.
...
name|OUT_DIR
operator|+
literal|"/retainDirectObjectTest.pdf"
argument_list|)
expr_stmt|;
name|pdf
operator|.
