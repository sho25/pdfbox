...
argument_list|()
decl_stmt|;
comment|// add a string to the COSArrayList
comment|// with a duplicate entry
name|cosArrayList
operator|.
name|add
argument_list|(
...
name|assertTrue
argument_list|(
literal|"Internal COSArray size shall be 4"
argument_list|,
name|cosArrayList
operator|.
name|toList
...
name|assertTrue
argument_list|(
literal|"Internal COSArray size shall be 2"
argument_list|,
name|cosArrayList
operator|.
name|toList
