...
block|}
block|}
comment|/**      * PDFBOX-4366: Create and test a checkbox with no /AP. The created file works with Adobe Reader!      *       * @throws IOException       */
specifier|public
name|void
name|testCheckBoxNoAppearance
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// need this or it won't appear on Adobe Reader
name|doc
operator|.
...
argument_list|)
expr_stmt|;
comment|// 4 is checkmark, 8 is cross
name|widget
operator|.
