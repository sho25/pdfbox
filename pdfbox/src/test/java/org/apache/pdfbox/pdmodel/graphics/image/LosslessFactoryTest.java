...
expr_stmt|;
block|}
comment|/**      * Tests ARGB LosslessFactoryTest#createFromImage(PDDocument document,      * BufferedImage image) with BITMASK transparency      *      * @throws java.io.IOException      */
specifier|public
name|void
name|testCreateLosslessFromImageBITMASK
parameter_list|()
throws|throws
name|IOException
block|{
