...
expr_stmt|;
block|}
comment|/**      * Tests USHORT_555_RGB LosslessFactoryTest#createFromImage(PDDocument document, BufferedImage      * image). This should create an 8-bit-image; prevent the problems from PDFBOX-4674 in case      * image creation is modified in the future.      *      * @throws java.io.IOException      */
specifier|public
name|void
name|testCreateLosslessFromImageUSHORT_555_RGB
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
comment|/**      * Tests LosslessFactoryTest#createFromImage(PDDocument document,      * BufferedImage image) with a transparent 1 bit GIF. (PDFBOX-4672)      * This ends up as RGB because the 1 bit fast path doesn't support transparency.      *      * @throws java.io.IOException      */
specifier|public
name|void
name|testCreateLosslessFromTransparent1BitGIF
parameter_list|()
throws|throws
name|IOException
block|{
...
name|getResourceAsStream
argument_list|(
literal|"gif-1bit-transparent.gif"
argument_list|)
argument_list|)
decl_stmt|;
name|assertEquals
...
name|testResultsDir
argument_list|,
literal|"gif-1bit-transparent.pdf"
argument_list|)
expr_stmt|;
block|}
