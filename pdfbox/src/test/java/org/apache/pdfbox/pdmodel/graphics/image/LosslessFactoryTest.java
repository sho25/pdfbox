...
expr_stmt|;
block|}
comment|/**      * Tests ARGB LosslessFactoryTest#createFromImage(PDDocument document,      * BufferedImage image)      *      * @throws java.io.IOException      */
specifier|public
name|void
name|testCreateLosslessFromImageARGB
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
comment|/**      * Check whether images are identical.      *      * @param expectedImage      * @param actualImage      */
specifier|private
name|void
name|checkIdent
parameter_list|(
