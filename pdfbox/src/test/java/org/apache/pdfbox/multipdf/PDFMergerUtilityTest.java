...
expr_stmt|;
block|}
comment|/**      * PDFBOX-4423: test merging a PDF where a widget has no StructParent.      *       * @throws IOException       */
specifier|public
name|void
name|testStructureTreeMerge7
parameter_list|()
throws|throws
name|IOException
block|{
...
name|TARGETPDFDIR
argument_list|,
literal|"PDFBOX-4423-000746.pdf"
argument_list|)
argument_list|)
decl_stmt|;
name|PDStructureTreeRoot
...
name|TARGETTESTDIR
argument_list|,
literal|"PDFBOX-4423-merged.pdf"
argument_list|)
argument_list|)
expr_stmt|;
name|dst
...
expr_stmt|;
block|}
comment|/**      * PDFBOX-4009: Test that ParentTreeNextKey is recalculated correctly.      */
specifier|public
name|void
name|testMissingParentTreeNextKey
parameter_list|()
throws|throws
name|IOException
block|{
...
comment|// so the new numbers should be 321+328..327+328, i.e. 649..655,
comment|// and this ParentTreeNextKey is 656 at the end.
name|dst
operator|.
name|getDocumentCatalog
argument_list|()
...
name|TARGETTESTDIR
argument_list|,
literal|"PDFBOX-4418-000314-merged.pdf"
argument_list|)
argument_list|)
expr_stmt|;
name|dst
...
expr_stmt|;
block|}
comment|/**      * PDFBOX-4429: merge into destination that has /StructParent(s) entries in the destination file      * but no structure tree.      *      * @throws IOException      */
specifier|public
name|void
name|testMergeBogusStructParents1
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
comment|/**      * PDFBOX-4429: merge into destination that has /StructParent(s) entries in the source file but      * no structure tree.      *      * @throws IOException      */
specifier|public
name|void
name|testMergeBogusStructParents2
parameter_list|()
throws|throws
name|IOException
block|{
