...
block|}
block|}
comment|/**      * PDFBOX-3999: check that entries in the number tree only reference pages from the page tree.      *       * @throws IOException       */
specifier|public
name|void
...
name|println
argument_list|(
literal|"Downloading GeneralForbearance.pdf..."
argument_list|)
expr_stmt|;
name|is
operator|=
...
name|URL
argument_list|(
literal|"https://issues.apache.org/jira/secure/attachment/12896905/GeneralForbearance.pdf"
argument_list|)
operator|.
name|openStream
argument_list|()
...
literal|"target"
argument_list|,
literal|"GeneralForbearance.pdf"
argument_list|)
argument_list|)
decl_stmt|;
name|IOUtils
...
name|println
argument_list|(
literal|"GeneralForbearance.pdf could not be downloaded, test skipped"
argument_list|)
expr_stmt|;
return|return;
block|}
...
argument_list|()
expr_stmt|;
comment|//if we don't close the src then we don't have an error
name|dst
operator|.
name|save
argument_list|(
...
literal|"target"
argument_list|,
literal|"GovFormPreFlattened-merged.pdf"
argument_list|)
argument_list|)
expr_stmt|;
name|dst
