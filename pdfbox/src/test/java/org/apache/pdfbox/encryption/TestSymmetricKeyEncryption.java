...
expr_stmt|;
block|}
comment|/**      * PDFBOX-4308: test that index colorspace table string doesn't get      * corrupted when encrypting. This happened because the table was used by      * two dictionaries, and when saving one string ended up as a direct object      * and the other (but same java object) ended up as an indirect object.      * Encryption used the wrong object number and/or the object was encrypted      * twice.      *      * @throws IOException      */
specifier|public
name|void
name|testPDFBox4308
parameter_list|()
