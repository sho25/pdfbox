...
expr_stmt|;
block|}
comment|/**      * Test parsing the "WXMDXCYRWFDCMOSFQJ5OAJIAFXYRZ5OA.pdf" file, which is susceptible to      * regression.      *      * @throws IOException      */
annotation|@
name|Test
specifier|public
name|void
...
name|TARGETPDFDIR
argument_list|,
literal|"PDFBOX-4153-WXMDXCYRWFDCMOSFQJ5OAJIAFXYRZ5OA.pdf"
argument_list|)
argument_list|)
init|)
block|{
...
block|}
block|}
comment|/**      * Test that PDFBOX-4490 has 3 pages.      *      * @throws IOException      */
annotation|@
name|Test
specifier|public
name|void
