...
expr_stmt|;
block|}
comment|// this hexadecimal encoding is used in pdfs generated by TeX/LateX
elseif|else
if|if
condition|(
name|nameStr
...
name|warn
argument_list|(
literal|"Not a number in hexadecimal character name: "
operator|+
name|nameStr
argument_list|)
expr_stmt|;
block|}
block|}
comment|// this decimal encoding is used in pdfs generated by TeX/LateX
elseif|else
if|if
condition|(
name|nameStr
...
name|warn
argument_list|(
literal|"Not a number in dezimal character name: "
operator|+
name|nameStr
argument_list|)
expr_stmt|;
