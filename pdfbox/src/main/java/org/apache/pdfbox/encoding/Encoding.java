...
argument_list|)
expr_stmt|;
comment|// add some (alternative) glyph mappings. These are missing in
comment|// the original copy of the adobe glyphlist.txt
comment|// also mapped as anglebracketleft
name|NAME_TO_CHARACTER
operator|.
name|put
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// also mapped as anglebracketright
name|NAME_TO_CHARACTER
operator|.
name|put
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// also mapped as copyright
name|NAME_TO_CHARACTER
operator|.
name|put
argument_list|(
