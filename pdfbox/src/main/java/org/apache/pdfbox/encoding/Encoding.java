...
block|}
block|}
comment|// this encoding is used in pdfs generated with TeX/LateX
elseif|else
if|if
condition|(
name|name
...
argument_list|)
decl_stmt|;
comment|// add some additional mapping for values< 32 and = 127
if|if
condition|(
name|value
operator|>=
...
name|warn
argument_list|(
literal|"Not a number in character name: "
operator|+
name|name
argument_list|)
expr_stmt|;
