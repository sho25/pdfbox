...
expr_stmt|;
block|}
comment|// PDFBOX-4540: because objectKeys is accessible from outside, it is possible
comment|// that a COSObject obj is already in the objectKeys map.
name|COSObjectKey
name|key
init|=
name|objectKeys
