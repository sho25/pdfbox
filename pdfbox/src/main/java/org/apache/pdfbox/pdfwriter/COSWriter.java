...
expr_stmt|;
block|}
comment|/**      * COSWriter constructor for incremental updates.       *      * @param outputStream output stream where the new PDF data will be written      * @param inputStream input stream containing source PDF data      *       * @throws IOException if something went wrong      * @deprecated Use {@link #COSWriter(OutputStream, RandomAccessRead)} instead      */
specifier|public
name|COSWriter
parameter_list|(
name|OutputStream
...
block|}
block|}
comment|// get only the incremental bytes to be signed (includes /ByteRange but not /Contents)
name|byte
index|[]
name|signBuffer
init|=
...
control|)
block|{
comment|// https://stackoverflow.com/questions/2817752/java-code-to-convert-byte-to-hexadecimal
name|output
operator|.
name|write
argument_list|(
