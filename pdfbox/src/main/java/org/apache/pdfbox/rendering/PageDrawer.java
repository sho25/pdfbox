...
case|:
default|default:
comment|// set to the initial translation plus cropbox, and
comment|// adjust apply (x,y) at the initial scale
comment|// however... what if the initial xform was e.g. rotated at 45Â°?
name|graphics
operator|.
name|setTransform
argument_list|(
...
parameter_list|()
block|{
comment|//TODO use image width() ? Need rotated PDF to be sure.
name|BufferedImage
name|gray
init|=
operator|new
