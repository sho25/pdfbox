...
argument_list|()
decl_stmt|;
comment|/**      * Constructor.      *       * @param renderer renderer to render the page.      * @param page the page that is to be rendered.      * @throws IOException If there is an error loading properties from the file.      */
specifier|public
name|PageDrawer
parameter_list|(
name|PDFRenderer
...
expr_stmt|;
block|}
comment|/**      * Draws the pattern stream to the requested context.      *      * @param g The graphics context to draw onto.      * @param pattern The tiling pattern to be used.      * @param colorSpace color space for this tiling.      * @param color color for this tiling.      * @throws IOException If there is an IO error while drawing the page.      */
specifier|public
name|void
...
return|;
block|}
comment|// fixme: shading needs to use the correct matrix
name|Matrix
name|patternMatrix
init|=
name|shadingPattern
