...
return|return;
block|}
comment|//TODO DRY-refactor this and the code from beginMarkedContentSequence() when PDFBOX-4399 is mostly done
name|PDPropertyList
name|propertyList
init|=
name|annotation
...
return|;
block|}
comment|/**      * Handle hidden optional content groups      *      * @see org.apache.pdfbox.contentstream.PDFStreamEngine#processOperator(Operator, List)      */
annotation|@
name|Override
specifier|protected
name|void
