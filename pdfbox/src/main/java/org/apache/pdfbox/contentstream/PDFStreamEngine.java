...
expr_stmt|;
block|}
comment|/**      * Processes the given tiling pattern.      *      * @param tilingPattern tiling patten      */
specifier|protected
specifier|final
name|void
...
argument_list|()
expr_stmt|;
comment|// note: we don't transform the CTM using the stream's matrix, as TilingPaint handles this
comment|// clip to bounding box
name|PDRectangle
name|bbox
init|=
