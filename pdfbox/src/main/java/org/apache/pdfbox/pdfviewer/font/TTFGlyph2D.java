...
literal|null
decl_stmt|;
comment|/**      * Constructor.      *       * @param trueTypeFont the true type font containing the glyphs      * @param fontname the name of the given font      * @param symbolFont indicates if the font is a symbolic font      * @param encoding the encoding of the font      *       */
specifier|public
name|TTFGlyph2D
parameter_list|(
name|TrueTypeFont
...
expr_stmt|;
block|}
comment|/**      * Constructor.      *       * @param trueTypeFont the true type font containing the glyphs      * @param fontname the name of the given font      * @param symbolFont indicates if the font is a symbolic font      * @param encoding the encoding of the font      * @param cid2gidMapping an optional CID2GID mapping      */
specifier|public
name|TTFGlyph2D
parameter_list|(
name|TrueTypeFont
...
expr_stmt|;
block|}
comment|/**      * Constructor.      *       * @param trueTypeFont the true type font containing the glyphs      * @param fontname the name of the given font      * @param symbolFont indicates if the font is a symbolic font      * @param encoding the encoding of the font      * @param cMap an optional CMap      */
specifier|public
name|TTFGlyph2D
parameter_list|(
name|TrueTypeFont
...
expr_stmt|;
block|}
comment|/**      * Constructor.      *       * @param trueTypeFont the true type font containing the glyphs      * @param fontname the name of the given font      * @param symbolFont indicates if the font is a symbolic font      * @param encoding the encoding of the font      * @param cid2gidMapping an optional CID2GID mapping      * @param cMap an optional CMap      */
specifier|public
name|TTFGlyph2D
parameter_list|(
name|TrueTypeFont
