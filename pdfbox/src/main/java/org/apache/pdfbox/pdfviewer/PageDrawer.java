...
argument_list|()
decl_stmt|;
comment|// Set translation to 0,0. We only need the scaling and shearing except for type 3 fonts
if|if
condition|(
operator|!
name|font
...
block|{
comment|// Use AWT to render the font (Type1 fonts, standard14 fonts, if the embedded font is substituted)
