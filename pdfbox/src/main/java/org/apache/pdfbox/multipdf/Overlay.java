...
name|PDDocument
argument_list|>
name|specificPageOverlayDocuments
parameter_list|)
throws|throws
name|IOException
block|{
...
return|;
block|}
comment|/**      * Close all input documents which were used for the overlay and opened by this class.      *      * @throws IOException if something went wrong      */
annotation|@
name|Override
specifier|public
name|void
...
argument_list|)
expr_stmt|;
comment|// if debugging, insert
comment|// 0 0 overlayMediaBox.getHeight() overlayMediaBox.getWidth() re\ns\n
comment|// into the content stream
name|overlayStream
operator|.
name|append
argument_list|(
...
return|;
block|}
comment|/**      * Calculate the transform to be used when positioning the overlay. The default implementation      * centers on the destination. Override this method to do your own, e.g. move to a corner, or      * rotate.      *      * @param page The page that will get the overlay.      * @param overlayMediaBox The overlay media box.      * @return The affine transform to be used.      */
specifier|protected
name|AffineTransform
name|calculateAffineTransform
parameter_list|(
