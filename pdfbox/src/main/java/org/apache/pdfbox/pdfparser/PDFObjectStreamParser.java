...
expr_stmt|;
block|}
comment|/**      * This will parse the tokens in the stream. This will close the stream when it is finished parsing.      *      * @return All of the objects in the stream.      * @throws IOException If there is an error while parsing the stream.      */
specifier|public
name|List
argument_list|<
name|COSObject
