...
condition|)
block|{
comment|// brute force search for startxref
name|startXRefOffset
operator|=
name|bfSearchForStartXref
argument_list|()
expr_stmt|;
if|if
condition|(
...
name|debug
argument_list|(
literal|"Fixed offset for startxref "
operator|+
name|startXRefOffset
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**      * Check if the cross reference stream can be found at the current offset.      *       * @param startXRefOffset      * @return the revised offset      * @throws IOException      */
specifier|private
name|long
name|checkXRefStreamOffset
parameter_list|(
...
block|}
block|}
comment|// TODO cross check found objects
block|}
...
return|;
block|}
comment|/**      * Brute force search for startxref.      *       * @return the offset of startxref        *       * @throws IOException if something went wrong      */
specifier|private
name|long
name|bfSearchForStartXref
parameter_list|()
