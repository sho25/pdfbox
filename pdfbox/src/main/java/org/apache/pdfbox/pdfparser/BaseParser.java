...
literal|'r'
decl_stmt|;
comment|//private static final int E = 'e';
specifier|private
specifier|static
specifier|final
name|int
...
do|do
block|{
comment|//use a fail fast test for end of stream markers
name|byteRead
operator|=
name|pdfSource
operator|.
...
condition|)
block|{
comment|//only continue branch if "en"
name|byteRead
operator|=
name|pdfSource
operator|.
...
condition|)
block|{
comment|//found the whole marker
name|pdfSource
operator|.
name|unread
argument_list|(
