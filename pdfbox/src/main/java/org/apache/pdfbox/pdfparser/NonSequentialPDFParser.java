...
name|startXrefOffset
operator|-=
name|calculateXRefFixingOffset
argument_list|(
name|startXrefOffset
argument_list|)
expr_stmt|;
...
comment|// this part copied from the sequential parser
name|parseHeader
argument_list|()
expr_stmt|;
name|pdfSource
...
return|;
block|}
comment|/**      * Check if the cross reference table/stream can be found at the current offset.      *       * @param startXRefOffset      * @return the calculated offset      * @throws IOException      */
specifier|private
name|long
name|calculateXRefFixingOffset
parameter_list|(
...
block|}
block|}
comment|// TODO try to repair XRef streams
return|return
name|calculateFixingOffset
argument_list|(
name|startXRefOffset
...
return|;
block|}
comment|// the offset seems to be wrong -> seek to find the object we are looking for
name|long
name|newOffset
init|=
name|bfSearchXRef
...
block|}
block|}
comment|/**      * Brute force search for the xref entry.      *       * @return the offset of the xref entry      * @throws IOException if something went wrong      */
specifier|private
name|long
name|bfSearchXRef
parameter_list|(
