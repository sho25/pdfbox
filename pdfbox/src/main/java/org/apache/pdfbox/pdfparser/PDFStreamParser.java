...
return|;
block|}
comment|/**      * Looks up next 5 bytes if they contain only ASCII characters (no control      * sequences etc.).      *      * @return<code>true</code> if next 5 bytes are printable ASCII characters,      * otherwise<code>false</code>      */
specifier|private
name|boolean
name|hasNoFollowingBinData
parameter_list|(
