...
expr_stmt|;
block|}
comment|/**      * Will create scratch file if it does not exist already.      *       * @throws IOException if {@link #close()} was called or creating scratch file failed      */
specifier|private
specifier|final
name|void
...
block|}
block|}
comment|/**      * Enlarges the scratch file by a number of pages defined by      * {@link #ENLARGE_PAGE_COUNT}. This will create the scratch      * file via {@link #ensureFileExists()} if it does not exist already.      *       *<p>Only to be called under synchronization on {@link #freePages}.</p>      */
specifier|private
specifier|final
name|void
name|enlarge
...
argument_list|()
expr_stmt|;
comment|// handle corner case when close is called by another thread
name|java
operator|.
name|io
operator|.
