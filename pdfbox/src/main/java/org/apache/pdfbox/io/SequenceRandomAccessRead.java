...
return|;
block|}
comment|/**      * Switch to buffer with the given index.      *       * @param index the index of the buffer to be switched to      * @param calculatePosition calculate the new position if set to true      *       * @throws IOException if the given index exceeds the available number of buffers      */
specifier|private
name|void
name|switchBuffer
parameter_list|(
