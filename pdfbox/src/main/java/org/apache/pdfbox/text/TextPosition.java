...
return|;
block|}
comment|/**      * This will get the page rotation adjusted x position of the character.      * This is adjusted based on page rotation so that the upper left is 0,0 which is      * unlike PDF coordinates, which start at the bottom left. See also      *<a href="https://stackoverflow.com/questions/57067372/">this answer by Michael Klink</a> for      * further details and      *<a href="https://issues.apache.org/jira/browse/PDFBOX-4597">PDFBOX-4597</a> for a sample      * file.      *      * @return The x coordinate of the character.      */
specifier|public
name|float
name|getX
parameter_list|()
...
return|;
block|}
comment|/**      * This will get the page rotation adjusted x position of the character.      * This is adjusted based on page rotation so that the upper left is 0,0 which is      * unlike PDF coordinates, which start at the bottom left. See also      *<a href="https://stackoverflow.com/questions/57067372/">this answer by Michael Klink</a> for      * further details and      *<a href="https://issues.apache.org/jira/browse/PDFBOX-4597">PDFBOX-4597</a> for a sample      * file.      *      * @return The adjusted y coordinate of the character.      */
specifier|public
name|float
name|getY
parameter_list|()
...
return|;
block|}
comment|/**      * This will get the font size that has been set with the "Tf" operator (Set text font and      * size). When the text is rendered, it may appear bigger or smaller depending on the current      * transformation matrix (set by the "cm" operator) and the text matrix (set by the "Tm"      * operator).      *      * @return The font size.      */
specifier|public
name|float
name|getFontSize
parameter_list|()
...
return|;
block|}
comment|/**      * This will get the X scaling factor. This is dependent on the current transformation matrix      * (set by the "cm" operator), the text matrix (set by the "Tm" operator) and the font size (set      * by the "Tf" operator).      *      * @return The X scaling factor.      */
specifier|public
name|float
name|getXScale
parameter_list|()
...
return|;
block|}
comment|/**      * This will get the x coordinate of the end position. This is the unadjusted value passed into      * the constructor.      *      * @return The unadjusted x coordinate of the end position      */
specifier|public
name|float
name|getEndX
parameter_list|()
...
return|;
block|}
comment|/**      * This will get the y coordinate of the end position. This is the unadjusted value passed into      * the constructor.      *      * @return The unadjusted y coordinate of the end position      */
specifier|public
name|float
name|getEndY
parameter_list|()
...
return|;
block|}
comment|/**      * This will get the rotation of the page that the text is located in. This is the unadjusted      * value passed into the constructor.      *      * @return The unadjusted rotation of the page that the text is located in      */
specifier|public
name|int
name|getRotation
parameter_list|()
...
return|;
block|}
comment|/**      * This will get the height of the page that the text is located in. This is the unadjusted      * value passed into the constructor.      *      * @return The unadjusted height of the page that the text is located in      */
specifier|public
name|float
name|getPageHeight
parameter_list|()
...
return|;
block|}
comment|/**      * This will get the width of the page that the text is located in. This is the unadjusted value      * passed into the constructor.      *      * @return The unadjusted width of the page that the text is located in      */
specifier|public
name|float
name|getPageWidth
parameter_list|()
...
literal|null
return|;
comment|// If changing this method, do not compare mutable fields (PDFBOX-4701)
block|}
annotation|@
name|Override
specifier|public
