...
name|IOException
function_decl|;
comment|/**      * Encodes data.      * @param input the byte stream to encode      * @param encoded the stream where encoded data will be written      * @param parameters the parameters used for encoding      * @throws IOException if the stream cannot be encoded      */
specifier|public
specifier|final
name|void
name|encode
