...
condition|)
block|{
comment|// Algorithm 13: validate permissions ("Perms" field)
try|try
block|{
name|Cipher
name|cipher
...
condition|)
block|{
comment|// Shall not be used. This value was used by a deprecated Adobe extension.
throw|throw
operator|new
name|IOException
argument_list|(
literal|"Unsupported Encryption Revision "
operator|+
name|encRevision
argument_list|)
throw|;
...
condition|)
block|{
comment|//Algorithm 2.A, based on SHA-2 and AES
name|byte
index|[]
name|hash
decl_stmt|,
