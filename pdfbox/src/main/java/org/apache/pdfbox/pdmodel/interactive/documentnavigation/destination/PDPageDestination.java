...
return|;
block|}
comment|// climb up the page tree up to the top to be able to call PageTree.indexOf for a page dictionary
specifier|private
name|int
name|indexOfPageTree
parameter_list|(
...
condition|)
block|{
comment|// now parent is the highest pages node
name|PDPageTree
name|pages
init|=
operator|new
