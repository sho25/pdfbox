...
condition|)
block|{
comment|// some fonts may appear many times (see test_1fd9a_test.pdf)
if|if
condition|(
name|seenFonts
operator|.
...
block|}
block|}
comment|/**      * Adds the given font to the resources of the current page.      *       * @param font the font to be added      * @return the font name to be used within the content stream.      */
specifier|public
name|String
name|addFont
parameter_list|(
...
return|;
block|}
comment|/**      * Adds the given font to the resources of the current page using the given font key.      *       * @param font the font to be added      * @param fontKey key to used to map to the given font      * @return the font name to be used within the content stream.      */
specifier|public
name|String
name|addFont
parameter_list|(
...
return|;
block|}
comment|// generates unique IDs for new resource entries
specifier|private
specifier|final
name|String
name|getNextUniqueKey
...
return|;
block|}
comment|/**      * Remove the xobject with given name.      *       * @param xobjectName the name of the xobject to be removed.      */
specifier|public
name|void
name|removeXObject
parameter_list|(
...
block|}
block|}
comment|/**      * Remove the font with given name.      *       * @param fontName the name of the font to be removed.      */
specifier|public
name|void
name|removeFont
parameter_list|(
