...
begin_comment
comment|/**  * this class represent certificate dictionary that is in the seed value which puts constraints on  * certificates when signing documents  *  * @author Hossam Hazem  */
end_comment
...
expr_stmt|;
block|}
comment|/**      * Returns array of byte arrays that contains DER-encoded X.509v3 certificates      */
specifier|public
name|List
argument_list|<
name|byte
...
name|base
decl_stmt|;
name|removeByteArrayFromCOSArray
argument_list|(
name|subject
argument_list|,
name|array
...
return|;
block|}
comment|/**      * (Optional; PDF 1.7) A name indicating the usage of the URL entry. There are standard uses and      * there can be implementation-specific uses for this URL. The following value specifies a valid      * standard usage:      *<ul>      *<li>Browser, The URL references content that should be displayed in a web browser to allow      * enrolling for a new credential if a matching credential is not found. The Ff attribute’s URL      * bit is ignored for this usage.</li>      *<li>ASSP, The URL references a signature web service that can be used for server-based      * signing. If the Ff attribute’s URL bit indicates that this is a required constraint, this      * implies that the credential used when signing must come from this server.</li>      *</ul>      * if urlType is not set the default is Browser for URL      *      * @param urlType      */
specifier|public
name|void
name|setURLType
parameter_list|(
