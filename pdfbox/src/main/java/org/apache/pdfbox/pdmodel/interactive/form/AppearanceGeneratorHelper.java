...
parameter_list|()
block|{
comment|// add font resources which might be available at the field
comment|// level but are not at the AcroForm level to the AcroForm
comment|// to match Adobe Reader/Acrobat behavior
if|if
condition|(
name|field
operator|.
...
name|debug
argument_list|(
literal|"Adding font resource "
operator|+
name|fontResourceName
operator|+
literal|" from widget to AcroForm"
argument_list|)
expr_stmt|;
name|acroFormResources
operator|.
...
control|)
block|{
comment|// some fields have the /Da at the widget level if the
comment|// widgets differ in layout.
name|PDDefaultAppearanceString
...
name|defaultAppearance
operator|=
name|getWidgetDefaultAppearanceString
argument_list|(
name|widget
argument_list|)
expr_stmt|;
...
name|appearanceStream
operator|=
name|prepareNormalAppearanceStream
argument_list|(
name|widget
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|// create indexEntries from options
name|indexEntries
operator|=
operator|new
name|ArrayList
