...
argument_list|)
decl_stmt|;
comment|// scale of font glyph units
specifier|private
specifier|static
specifier|final
name|float
...
argument_list|()
decl_stmt|;
comment|// calculation of the vertical offset from where the text will be printed
name|float
name|verticalOffset
init|=
...
return|;
block|}
comment|/**      * Calculates where to start putting the text in the box. The positioning is not quite as      * accurate as when Acrobat places the elements, but it works though.      *       * @param paddingEdge the content edge      * @param contentEdge the content edge      * @param pdFont the font to use for formatting      * @param fontSite the font size to use for formating      *      * @return the sting for representing the start position of the text      *      * @throws IOException If there is an error calculating the text position.      */
specifier|private
name|float
name|calculateVerticalOffset
parameter_list|(
...
comment|// the font's caps are larger than the height of the paddingEdge
if|if
condition|(
name|capHeight
operator|>
...
argument_list|()
decl_stmt|;
comment|// as the font descriptor might be null or the cap height might be 0
comment|// alternate calculation for the cap height
if|if
condition|(
name|fontDescriptor
operator|==
...
condition|)
block|{
comment|// TODO: refine the calculation if needed
return|return
name|pdFont
operator|.
name|getBoundingBox
...
block|}
block|}
comment|/**      * Get the descent for a font.      * @throws IOException in case the font information can not be retrieved.      */
specifier|private
name|float
name|getDescent
parameter_list|(
