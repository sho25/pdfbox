...
comment|// TODO support appearances other than "normal"
block|}
comment|/*                  * Adobe Acrobat always recreates the complete appearance stream if there is an appearance characteristics                  * entry (the widget dictionaries MK entry). In addition if there is no content yet also create the apperance                  * stream from the entries.                  *                   */
if|if
condition|(
name|widget
operator|.
...
argument_list|()
decl_stmt|;
comment|// TODO: support more entries like patterns, background color etc.
if|if
condition|(
name|appearanceCharacteristics
operator|!=
