...
index|]
decl_stmt|;
comment|// there maybe a ProfileDataException or a CMMException as there
comment|// are some issues when loading ICC_Profiles, see PDFBOX-1295
comment|// Try to create a color as test ...
operator|new
name|Color
argument_list|(
name|cSpace
...
parameter_list|)
block|{
comment|// we are using an alternate colorspace as fallback
name|LOG
operator|.
name|debug
argument_list|(
literal|"Can't read ICC-profile, using alternate colorspace instead"
argument_list|)
expr_stmt|;
name|List
name|alternateCSList
init|=
