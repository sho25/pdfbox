...
return|;
block|}
comment|/**      * Returns the range for a certain component number.      * This is will never return null.      * If it is not present then the range 0..1 will be returned.      * @param n the component number to get the range for      * @return the range for this component      */
specifier|public
name|PDRange
name|getRangeForComponent
parameter_list|(
