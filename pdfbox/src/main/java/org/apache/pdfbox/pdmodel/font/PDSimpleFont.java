...
condition|)
block|{
name|readEncodingFromDictionary
argument_list|(
operator|(
name|COSDictionary
operator|)
...
argument_list|()
expr_stmt|;
comment|//Map<Integer, String> codeToName = MacOSRomanEncoding.INSTANCE.getCodeToNameMap();
name|Map
argument_list|<
name|Integer
argument_list|,
...
condition|)
block|{
comment|// todo: do we need to check if entries actually differ from the base encoding?
return|return
literal|false
return|;
block|}
