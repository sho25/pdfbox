...
return|;
block|}
comment|/**      * Returns the default crypt filter (for public-key security handler).      *       * @return the default crypt filter if available.      */
specifier|public
name|PDCryptFilterDictionary
...
parameter_list|)
block|{
comment|// See CF in "Table 20 – Entries common to all encryption dictionaries"
name|COSBase
name|base
init|=
name|dictionary
...
expr_stmt|;
block|}
comment|/**      * Sets the default crypt filter (for public-key security handler).      *      * @param defaultFilterDictionary the standard crypt filter to set      */
specifier|public
name|void
