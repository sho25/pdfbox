...
return|;
block|}
comment|/*      * Get the on value for an individual widget by it's index.      */
specifier|private
name|String
name|getOnValue
parameter_list|(
...
return|;
block|}
comment|/*      * Get the on value for an individual widget.      */
specifier|private
name|String
name|getOnValueForWidget
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// get the values the options are pointing to as
comment|// this might not be numerical
comment|// see PDFBOX-3682
if|if
condition|(
name|optionsIndex
operator|!=
