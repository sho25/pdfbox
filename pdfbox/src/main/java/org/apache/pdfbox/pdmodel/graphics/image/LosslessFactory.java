...
return|;
block|}
comment|/**      * Create a PDImageXObject with the data encoded with the Flate filter.      *      * @param document The document.      * @param byteArray array with data.      * @return the newly created PDImageXObject with the data compressed.      * @throws IOException      */
specifier|private
specifier|static
name|PDImageXObject
name|prepareImageXObject
