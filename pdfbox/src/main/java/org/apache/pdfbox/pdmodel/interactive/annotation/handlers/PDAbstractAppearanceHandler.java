...
return|;
block|}
comment|/**      * Get a rectangle enlarged by the differences.      *       *<p>Creates a new rectangle with differences added to each side.      * .      * @param rectangle the rectangle.      * @param diifferences the differences to apply.      * @return the padded rectangle.      */
name|PDRectangle
...
return|;
block|}
comment|/**      * Get a rectangle with the differences applied to each side.      *       *<p>Creates a new rectangle with differences added to each side.      * .      * @param rectangle the rectangle.      * @param diifferences the differences to apply.      * @return the padded rectangle.      */
name|PDRectangle
