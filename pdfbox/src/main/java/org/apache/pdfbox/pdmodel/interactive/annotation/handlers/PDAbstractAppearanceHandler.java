...
argument_list|()
decl_stmt|;
comment|/**      * Line ending styles where the shape changes its angle, e.g. arrows.      */
specifier|protected
specifier|static
specifier|final
name|Set
...
block|}
block|}
comment|/**      * Draw a line ending style.      *       * @param style      * @param cs      * @param x      * @param y      * @param width      * @param hasStroke      * @param hasBackground      * @param ending false if left, true if right of an imagined horizontal line (important for      * arrows).      *      * @throws IOException      */
name|void
name|drawStyle
parameter_list|(
name|String
