...
argument_list|)
expr_stmt|;
comment|// propagate resources to the page
if|if
condition|(
name|sourcePage
operator|.
...
condition|)
block|{
comment|// create a new stream to prefix existing stream
name|PDStream
name|prefixStream
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// restore the pre-append graphics state
if|if
condition|(
name|resetContext
condition|)
...
name|doc
expr_stmt|;
comment|//setResources(appearance.getResources());
block|}
