...
comment|// ty
block|}
comment|// TODO shouldn't create PageDrawer here, the class needs to be overridable
comment|// can we re-use the existing PageDrawer somehow and just push/pop its graphics state?
name|PageDrawer
name|drawer
init|=
operator|new
