...
name|IOException
function_decl|;
comment|/**      * Returns the advance width of the given character, in glyph space.</p>      *       * If you want the visual bounds of the glyph then call getPath(..) on the appropriate      * PDFont subclass to retrieve the glyph outline as a GeneralPath instead.      *      * @param code character code      */
name|float
name|getWidth
parameter_list|(
name|int
