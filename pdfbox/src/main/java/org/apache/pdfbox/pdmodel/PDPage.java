...
return|;
block|}
comment|/**      * This will return a list of the annotations for this page.      *      * @param annotationFilter the annotation filter provided allowing to filter out specific annotations      * @return List of the PDAnnotation objects, never null. The returned list is backed by the      * annotations COSArray, so any adding or deleting in this list will change the document too.      *       * @throws IOException If there is an error while creating the annotation list.      */
specifier|public
name|List
argument_list|<
name|PDAnnotation
...
expr_stmt|;
block|}
comment|/**      * Get the user unit. This is a positive number that shall give the size of default user space      * units, in multiples of 1/72 inch, or 1 if it hasn't been set. This is supported by PDF 1.6      * and higher.      *      * @return the user unit.      */
specifier|public
name|float
name|getUserUnit
parameter_list|()
...
return|;
block|}
comment|/**      * Get the user unit. This is a positive number that shall give the size of default user space      * units, in multiples of 1/72 inch. This is supported by PDF 1.6 and higher.      *      * @param userUnit      * throws IllegalArgumentException if the parameter is not positive.      */
specifier|public
name|void
name|setUserUnit
parameter_list|(
...
argument_list|(
literal|"User unit must be positive"
argument_list|)
throw|;
block|}
name|page
