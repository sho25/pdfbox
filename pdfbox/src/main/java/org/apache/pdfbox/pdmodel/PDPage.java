...
argument_list|()
decl_stmt|;
comment|// "the region to which the contents of the page shall be clipped"
name|PDRectangle
name|tmpCropBox
init|=
name|findCropBox
argument_list|()
decl_stmt|;
comment|// "Content falling outside this boundary may safely be discarded"
name|PDRectangle
name|tmpMediaBox
init|=
name|findMediaBox
argument_list|()
decl_stmt|;
comment|// "The crop, bleed, trim, and art boxes shall not ordinarily extend
comment|// beyond the boundaries of the media box. If they do, they are
comment|// effectively reduced to their intersection with the media box.
if|if
condition|(
name|tmpMediaBox
operator|.
