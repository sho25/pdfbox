...
parameter_list|()
block|{
comment|// use well known substitutions if the environments doesn't provide native fonts for the 14 standard fonts
comment|// Times-Roman -> Serif
if|if
condition|(
operator|!
name|addFontMapping
...
literal|"Times-BoldItalic"
argument_list|,
literal|"Serif.bolditalic"
argument_list|)
expr_stmt|;
block|}
comment|// Helvetica -> SansSerif
if|if
condition|(
operator|!
name|addFontMapping
...
literal|"Helvetica-BoldOblique"
argument_list|,
literal|"SansSerif.bolditalic"
argument_list|)
expr_stmt|;
block|}
comment|// Courier -> Monospaced
if|if
condition|(
operator|!
name|addFontMapping
...
literal|"Courier-BoldOblique"
argument_list|,
literal|"Monospaced.bolditalic"
argument_list|)
expr_stmt|;
block|}
comment|// some well known (??) substitutions found on fedora linux
name|addFontMapping
argument_list|(
literal|"Symbol"
argument_list|,
literal|"StandardSymbolsL"
argument_list|)
expr_stmt|;
name|addFontMapping
argument_list|(
