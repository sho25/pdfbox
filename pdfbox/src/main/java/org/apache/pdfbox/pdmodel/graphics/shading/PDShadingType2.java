...
block|}
block|}
comment|/**      * This will return the function used to convert the color values.      *      * @return The function      *       * @exception IOException If we are unable to create the PDFunction object.       *       * @deprecated      *       */
specifier|public
name|PDFunction
name|getFunction
parameter_list|()
...
block|{
comment|// TODO
comment|// change the return value to COSArray
return|return
literal|null
return|;
block|}
