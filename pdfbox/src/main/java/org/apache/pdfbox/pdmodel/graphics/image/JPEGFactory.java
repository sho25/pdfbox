...
argument_list|)
expr_stmt|;
comment|// PDFBOX-4691: get from image metadata (faster because no decoding)
try|try
block|{
name|meta
operator|.
name|numComponents
operator|=
name|getNumComponentsFromImageMetadata
argument_list|(
name|reader
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"No image metadata, will decode image and use raster size"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|warn
argument_list|(
literal|"Error reading image metadata, will decode image and use raster size"
argument_list|,
name|ex
argument_list|)
expr_stmt|;
block|}
comment|// Old method: get from raster (slower)
name|ImageIO
operator|.
name|setUseCache
argument_list|(
...
decl_stmt|;
name|String
name|numScanComponents
init|=
name|xpath
operator|.
name|evaluate
argument_list|(
literal|"markerSequence/sos/@numScanComponents"
argument_list|,
name|root
argument_list|)
decl_stmt|;
