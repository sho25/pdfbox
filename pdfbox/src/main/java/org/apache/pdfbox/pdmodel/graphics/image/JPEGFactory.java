...
block|}
block|}
comment|// PDFBOX-4317 warn about progressive JPEG files
specifier|private
specifier|static
name|void
name|warnIfProgressive
...
name|warn
argument_list|(
literal|"Progressive JPEGs are not properly supported by Adobe Reader;"
argument_list|)
expr_stmt|;
name|LOG
operator|.
name|warn
argument_list|(
literal|"please check whether your PDF displays."
argument_list|)
expr_stmt|;
block|}
block|}
