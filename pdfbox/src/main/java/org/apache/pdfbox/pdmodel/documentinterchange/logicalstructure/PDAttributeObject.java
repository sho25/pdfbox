...
begin_comment
comment|/**  * An attribute object.  *  * @author<a href="mailto:Johannes%20Koch%20%3Ckoch@apache.org%3E">Johannes Koch</a>  * @version $Revision: $  *  */
end_comment
...
return|;
block|}
comment|/**      * Notifies the attribute object change listeners if the attribute is changed.      *       * @param oldValue old value      * @param newValue new value      */
specifier|protected
name|void
