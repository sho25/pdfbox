...
expr_stmt|;
block|}
comment|/**      * This will get the key of this XObjectForm in the structural parent tree. Required if the form      * XObject contains marked-content sequences that are structural content items.      *      * @return the integer key of the XObjectForm's entry in the structural parent tree or -1 if      * there isn't any.      */
specifier|public
name|int
...
expr_stmt|;
block|}
comment|/**      * This will get the optional content group or optional content membership dictionary.      *      * @return The optional content group or optional content membership dictionary or null if there      * is none.      */
specifier|public
name|PDPropertyList
...
return|;
block|}
comment|/**      * Sets the optional content group or optional content membership dictionary.      *      * @param oc The optional content group or optional content membership dictionary.      */
specifier|public
name|void
