...
comment|// this must be done after polyline draw, to avoid line crossing a filled shape
if|if
condition|(
operator|!
name|LE_NONE
...
return|;
block|}
comment|//TODO refactor to remove double code drawStyle and related
comment|// (100% copied from line handler)
specifier|private
name|void
name|drawStyle
parameter_list|(
