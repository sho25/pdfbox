...
comment|// But if there is a color in /DS, then that one is used for text.
name|PDColor
name|strokingColor
init|=
...
condition|)
block|{
comment|// Try to get font from AcroForm default resources
comment|// Sample file: https://gitlab.freedesktop.org/poppler/poppler/issues/6
name|PDResources
...
return|;
block|}
comment|//TODO extractNonStrokingColor and extractFontDetails
comment|// might somehow be replaced with PDDefaultAppearanceString, which is quite similar.
specifier|private
name|void
name|extractFontDetails
parameter_list|(
...
name|warn
argument_list|(
literal|"Problem parsing /DA, will use default 'Helv 10'"
argument_list|,
name|ex
argument_list|)
expr_stmt|;
