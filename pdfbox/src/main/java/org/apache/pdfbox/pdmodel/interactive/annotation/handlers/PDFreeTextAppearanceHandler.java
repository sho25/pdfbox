...
comment|// in pdf_commenting_new.pdf file.
name|int
name|rotation
init|=
name|annotation
...
argument_list|()
decl_stmt|;
comment|// somewhat inspired by AppearanceGeneratorHelper.insertGeneratedAppearance()
name|cs
operator|.
name|beginText
argument_list|()
...
condition|)
block|{
comment|//TODO cloudy needs to be reviewed too.
name|factor
operator|=
literal|2
expr_stmt|;
...
argument_list|)
decl_stmt|;
comment|// used by Adobe, no idea where it comes from, actual font bbox max y is 0.931
...
literal|true
argument_list|)
comment|//TODO some reverse engineering needed to find out padding
operator|.
name|initialOffset
argument_list|(
name|xOffset
