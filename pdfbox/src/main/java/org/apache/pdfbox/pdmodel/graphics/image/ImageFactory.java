...
condition|)
block|{
comment|// PDFBOX-2057, handle TYPE_INT_A... types
comment|// See also
comment|// http://bugs.java.com/bugdatabase/view_bug.do?bug_id=4243485
name|alphaImage
operator|=
operator|new
name|BufferedImage
...
argument_list|()
decl_stmt|;
comment|// alpha value is in the highest byte
for|for
control|(
name|int
name|i
...
argument_list|()
decl_stmt|;
comment|// alpha value is at bytes 0...4...8...
for|for
control|(
name|int
name|i
...
block|{
comment|// This didn't work for INT types, see PDFBOX-2057. The raster returned has a
