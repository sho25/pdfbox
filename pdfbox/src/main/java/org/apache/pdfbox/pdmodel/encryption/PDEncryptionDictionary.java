...
name|VERSION0_UNDOCUMENTED_UNSUPPORTED
decl_stmt|;
comment|/**      * COS encryption dictionary.      */
specifier|protected
name|COSDictionary
...
expr_stmt|;
block|}
comment|/**      * creates a new encryption dictionary from the low level dictionary provided.      * @param d the low level dictionary that will be managed by the newly created object      */
specifier|public
name|PDEncryptionDictionary
parameter_list|(
name|COSDictionary
