...
name|warn
argument_list|(
literal|"Identity-V font seems to be missing vertical metrics: it has no 'vhea' table and no DW2 entry"
argument_list|)
expr_stmt|;
block|}
return|return;
block|}
comment|// Clear any data previously set from DW2 / W2
