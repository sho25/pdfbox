...
name|info
argument_list|(
literal|"fontfile3 not supported yet, subType is "
operator|+
name|ff3Stream
operator|.
name|getStream
...
condition|)
block|{
comment|// fallback to the first cmap (may not ne Unicode, so may produce poor results)
name|LOG
operator|.
name|warn
argument_list|(
literal|"Used fallback cmap for font "
operator|+
name|getBaseFont
argument_list|()
argument_list|)
