...
parameter_list|()
block|{     }
comment|/**      * Creates a new CCITT Fax compressed Image XObject from a TIFF file.      * @param document the document to create the image as part of.      * @param reader the random access TIFF file which contains a suitable CCITT compressed image      * @throws IOException if there is an error reading the TIFF data.      */
specifier|public
specifier|static
name|PDImageXObject
