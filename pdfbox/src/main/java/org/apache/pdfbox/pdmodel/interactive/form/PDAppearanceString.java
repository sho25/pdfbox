...
return|;
block|}
comment|/**      * Tests if the apperance stream already contains content.      *       * @param streamTokens individual tokens within the appearance stream      *      * @return true if it contains any content      */
specifier|private
name|boolean
...
comment|// TODO: verify the vertical alignment calculation
name|float
name|paddingLeft
init|=
name|Math
...
comment|// TODO: verify this with more samples
comment|//       verify fontHeight calculation which was taken from getVerticalOffset()
name|float
name|fontHeight
init|=
name|boundingBox
...
literal|0f
decl_stmt|;
comment|// Acrobat aligns left regardless of the quadding if the text is wider then the remaining width
name|float
name|stringWidth
init|=
operator|(
