...
condition|)
block|{
comment|// JPX images may embed a color space
name|InputStream
name|input
init|=
name|getStream
...
block|{
comment|// TODO what does the PDF spec say about this?
comment|// if the ColorSpace is missing, we try and guess it
if|if
condition|(
name|COSName
operator|.
...
block|{
comment|// this method must not return null
throw|throw
operator|new
name|IOException
argument_list|(
