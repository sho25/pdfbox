...
condition|)
block|{
comment|// /DeviceGray has only one element in Matte
comment|// See file from PDFBOX-1359, page 14
comment|// Root/Pages/Kids/[2]/Kids/[2]/Resources/XObject/Im1/Resources/XObject/Im0
name|matte
operator|=
operator|new
name|float
...
argument_list|)
operator|+
literal|" for Soft-Mask may not work properly"
argument_list|)
expr_stmt|;
name|matte
operator|=
