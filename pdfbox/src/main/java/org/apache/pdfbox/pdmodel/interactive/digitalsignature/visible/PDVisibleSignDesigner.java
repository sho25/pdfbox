...
expr_stmt|;
block|}
comment|/**      * @return Affine Transform parameters for PDF Matrix      *       * @deprecated use {@link #getTransform() }.      */
annotation|@
name|Deprecated
specifier|public
name|byte
...
return|;
block|}
comment|/**      *       * @param affineTransformParams      * @return Visible Signature Configuration Object      * @deprecated use {@link #transform}.      */
annotation|@
name|Deprecated
specifier|public
name|PDVisibleSignDesigner
