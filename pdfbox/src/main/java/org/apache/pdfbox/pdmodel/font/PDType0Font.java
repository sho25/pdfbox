...
block|}
block|}
comment|/**      * Returns the name of CJK CMap represented by the given CIDSystemInfo, if any.       */
specifier|private
name|String
name|getCJKCMap
parameter_list|(
...
parameter_list|)
block|{
comment|// CJK can fallback to using CIDSystemInfo
if|if
condition|(
name|ros
operator|.
