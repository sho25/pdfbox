...
literal|null
decl_stmt|;
comment|//TODO implement common PDShadingtype for 4 and 5
specifier|private
name|Area
name|area
init|=
...
argument_list|()
decl_stmt|;
comment|//TODO for later optimization
...
block|}
block|}
comment|/**      * create a java area that includes all the triangles.      */
specifier|protected
name|void
name|createArea
parameter_list|()
...
expr_stmt|;
block|}
comment|//TODO optimize: quit loop when triangle is found
block|}
else|else
block|{
if|if
