...
operator|+
literal|"Encoding defintion found without /Encoding line."
argument_list|)
expr_stmt|;
block|}
else|else
...
parameter_list|)
block|{
comment|// this is used to fix an apparent bug with the sun jdk where the mapping of
comment|// character code to glyph index done by native code is wrong; this does not happen with openjdk
try|try
block|{
name|Field
name|fGlyphs
