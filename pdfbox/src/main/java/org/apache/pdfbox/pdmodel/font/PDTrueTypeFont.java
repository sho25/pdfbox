...
try|try
block|{
comment|// as a workaround we try to rebuild the embedded subsfont
name|byte
index|[]
name|fontData
init|=
...
name|IOException
block|{
comment|// this is one possible case of an incomplete subfont which leads to a font exception
if|if
condition|(
name|getFontEncoding
argument_list|()
