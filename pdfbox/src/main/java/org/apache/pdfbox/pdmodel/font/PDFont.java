...
argument_list|)
decl_stmt|;
comment|// TODO move the Map to PDType1Font as these are the 14 Standard fonts
comment|// which are definitely Type 1 fonts
specifier|private
specifier|static
name|Map
argument_list|<
...
expr_stmt|;
block|}
comment|/**      * This will get or create the encoder.      *      * modified by Christophe Huault : DGBS Strasbourg huault@free.fr october 2004      *      * @return The encoding to use.      */
specifier|public
name|Encoding
name|getEncoding
parameter_list|()
