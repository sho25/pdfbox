...
argument_list|)
decl_stmt|;
comment|/**      * This will be set if the font has a toUnicode stream.      */
specifier|private
name|boolean
name|hasToUnicode
init|=
...
argument_list|()
decl_stmt|;
comment|// The converter isn't needed if an unicode mapping is already given by the font dictionary
if|if
condition|(
operator|!
name|hasToUnicode
...
argument_list|()
decl_stmt|;
comment|//font.getDictionaryObject( COSName.ENCODING );
if|if
condition|(
name|encoding
operator|==
...
argument_list|)
decl_stmt|;
comment|//on ajoute une entr�e /BaseEncoding dans /Encoding uniquement si elle en est absente
...
comment|//dans le flux r�f�renc� par � la cl� FileFont lui m�me situ� dans
comment|//le dictionnaire associ� � /FontDescriptor du dictionnaire de type /Font courrant
