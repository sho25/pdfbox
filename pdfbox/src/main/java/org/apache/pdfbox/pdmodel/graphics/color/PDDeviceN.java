...
expr_stmt|;
block|}
comment|/**      * Constructor.      *      * @param csAttributes The array containing all colorspace information.      */
specifier|public
name|PDDeviceN
parameter_list|(
name|COSArray
...
expr_stmt|;
block|}
comment|/**      * This will return the name of the color space.  For a PDDeviceN object      * this will always return "DeviceN"      *      * @return The name of the color space.      */
specifier|public
name|String
name|getName
parameter_list|()
...
condition|)
block|{
comment|// the DeviceN contains an attributes dictionary
name|deviceNAttributes
operator|=
operator|new
name|PDDeviceNAttributes
