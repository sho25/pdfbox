...
begin_comment
comment|/**  * This class is a convenience for creating page content streams. You MUST call close() when you  * are finished with this object.  *  * @author Ben Litchfield  */
end_comment
...
expr_stmt|;
block|}
comment|/**      * Set the font and font size to draw text with.      *      * @param font The font to use.      * @param fontSize The font size to draw the text.      * @param embedSubset True to subset this font when embedding it. Affects all uses of this font.      * @throws IOException If there is an error writing the font information.      */
specifier|public
name|void
name|setFont
parameter_list|(
...
name|IllegalStateException
argument_list|(
literal|"Must call beginText() before drawString()"
argument_list|)
throw|;
block|}
if|if
...
name|IllegalStateException
argument_list|(
literal|"Must call setFont() before drawString()"
argument_list|)
throw|;
block|}
name|PDFont
...
control|)
block|{
comment|// currently we only support subsetting Type0/CIDFontType2 fonts
if|if
condition|(
name|font
operator|instanceof
