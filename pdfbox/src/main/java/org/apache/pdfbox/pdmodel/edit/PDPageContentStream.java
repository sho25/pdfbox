...
expr_stmt|;
block|}
comment|/**      * Set the font to draw text with.      *      * @param font The font to use.      * @param fontSize The font size to draw the text.      * @param embedSubset True to subset this font when embedding it. Affects all uses of this font.      * @throws IOException If there is an error writing the font information.      */
specifier|public
name|void
name|setFont
parameter_list|(
