...
expr_stmt|;
block|}
comment|//Fonts including reverse lookup
name|fonts
operator|=
name|resources
operator|.
...
argument_list|)
expr_stmt|;
comment|//XObjects including reverse lookup
name|xobjects
operator|=
name|resources
operator|.
...
expr_stmt|;
block|}
comment|/**      * Fill the path.      *       * @throws IOException If there is an error while filling the path.      */
specifier|public
name|void
name|fill
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Clip path.      *       * @throws IOException If there is an error while clipping the path.      */
specifier|public
name|void
name|clipPath
parameter_list|(
