...
expr_stmt|;
block|}
comment|/**      * Constructor for an existing object reference.      *      * @param dictionary The existing dictionary.      */
specifier|public
name|PDObjectReference
parameter_list|(
name|COSDictionary
...
block|{
comment|// No XObject
comment|// TODO what else can be the target of the object reference?
block|}
block|}
return|return
literal|null
