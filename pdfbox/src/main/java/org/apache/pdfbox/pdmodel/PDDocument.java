...
return|;
block|}
comment|/**      * Check if the field already exists in the field list.      *      * @param acroFormFields the list of AcroForm fields.      * @param signatureField the signature field.      * @return true if the field already existed in the field list, false if not.      */
specifier|private
name|boolean
name|checkSignatureField
parameter_list|(
