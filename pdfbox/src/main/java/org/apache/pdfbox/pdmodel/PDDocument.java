...
name|visualSignature
operator|=
name|createInvisibleSignatureCOSDocument
argument_list|()
expr_stmt|;
block|}
...
name|IOException
block|{
comment|// This document must be tailored so that prepareVisibleSignature() finds all it wants.
name|PDDocument
name|doc
init|=
operator|new
...
argument_list|()
expr_stmt|;
comment|// need to save and reload so that COSDocument has an object list
return|return
name|PDDocument
operator|.
name|load
