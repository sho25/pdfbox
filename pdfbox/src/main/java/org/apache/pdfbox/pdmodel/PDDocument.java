...
block|}
block|}
comment|/**      * Save the PDF as an incremental update. This is only possible if the PDF was loaded from a      * file or a stream, not if the document was created in PDFBox itself.      *      * @param output stream to write. It should<i><b>not</b></i> point to the source file.      * @throws IOException if the output could not be written      * @throws IllegalStateException if the document was not loaded from a file or a stream.      */
specifier|public
name|void
...
name|warn
argument_list|(
literal|"Error closing SigningSupport"
argument_list|,
name|ioe
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Error closing COSDocument"
argument_list|,
name|ioe
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Error closing RandomAccessRead pdfSource"
argument_list|,
name|ioe
argument_list|)
expr_stmt|;
