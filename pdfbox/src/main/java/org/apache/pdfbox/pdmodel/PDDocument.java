...
begin_comment
comment|/**  * This is the in-memory representation of the PDF document.  You need to call  * close() on this object when you are done using it!!  *  * @author<a href="mailto:ben@benlitchfield.com">Ben Litchfield</a>  * @version $Revision: 1.47 $  */
end_comment
...
argument_list|()
decl_stmt|;
comment|// we have to center the ImageableArea if the cropBox is smaller than the mediaBox
if|if
condition|(
operator|!
name|mediaBox
...
name|PrinterException
argument_list|(
literal|"The delivered printJob is null."
argument_list|)
throw|;
block|}
name|AccessPermission
