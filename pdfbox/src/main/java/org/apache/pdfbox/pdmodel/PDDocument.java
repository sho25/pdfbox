...
return|;
block|}
comment|/**      * This will load a document from a url. Used for skipping corrupt pdf objects      *       * @param url The url to load the PDF from.      * @param force When true, the parser will skip corrupt pdf objects and will continue parsing at the next object in      *            the file      * @param useScratchFiles enables the usage of a scratch file if set to true      *       * @return The document that was loaded.      *       * @throws IOException If there is an error reading from the stream.      */
specifier|public
specifier|static
name|PDDocument
name|load
...
return|;
block|}
comment|/**      * This will load a document from a file. Allows for skipping corrupt pdf objects      *       * @param filename The name of the file to load.      * @param force When true, the parser will skip corrupt pdf objects and will continue parsing at the next object in      *            the file      * @param useScratchFiles enables the usage of a scratch file if set to true      *       * @return The document that was loaded.      *       * @throws IOException If there is an error reading from the stream.      */
specifier|public
specifier|static
name|PDDocument
name|load
