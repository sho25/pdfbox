...
condition|)
block|{
comment|// PDFBOX-3738 NeedAppearances true results in signature becoming invisible with Adobe Reader
if|if
condition|(
name|acroFormFields
operator|.
...
name|warn
argument_list|(
literal|"/NeedAppearances is set, signature may be ignored in Adobe Reader"
argument_list|)
expr_stmt|;
block|}
block|}
