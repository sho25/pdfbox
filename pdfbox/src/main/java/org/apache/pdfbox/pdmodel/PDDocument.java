...
expr_stmt|;
block|}
comment|/**      * Creates an empty PDF document.      * You need to add at least one page for the document to be valid.      *      * @param useScratchFiles enables the usage of a scratch file if set to true      */
specifier|public
name|PDDocument
parameter_list|(
name|boolean
...
expr_stmt|;
block|}
comment|/**      * Internal constructor which support setting scratch file usage      * via boolean parameter or directly (new). This will be only needed      * as long as the new ScratchFile handling is tested.      *       *<p>You need to add at least one page for the document to be valid.</p>      *      * @param useScratchFiles enables the usage of a scratch file if set to true      * @param memUsageSetting defines how memory is used for buffering PDF streams       */
specifier|private
name|PDDocument
parameter_list|(
name|boolean
...
return|;
block|}
comment|/**      * Parses a PDF.      *       * @param input byte array that contains the document.      *       * @return loaded document      *       * @throws IOException in case of a file reading or parsing error      */
specifier|public
specifier|static
name|PDDocument
name|load
...
return|;
block|}
comment|/**      * Parses a PDF.      *       * @param input byte array that contains the document.      * @param password password to be used for decryption      *       * @return loaded document      *       * @throws IOException in case of a file reading or parsing error      */
specifier|public
specifier|static
name|PDDocument
name|load
