...
condition|)
block|{
comment|// JPEGs may contain CMYK, YCbCr or YCCK decoded image data
name|int
name|transform
init|=
name|getApp14AdobeTransform
argument_list|(
name|img
argument_list|)
decl_stmt|;
...
return|;
block|}
comment|// YCbCrK jpegs are not supported by JAI, so that we have to do the conversion on our own
specifier|private
name|BufferedImage
name|convertYCCK2RGB
parameter_list|(
