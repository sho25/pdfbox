...
block|}
block|}
comment|/**      * Returns the given file as byte array.      * @param file File to be read      * @return given file as byte array      * @throws IOException if something went wrong during reading the file      */
specifier|public
specifier|static
name|byte
index|[]
...
return|;
block|}
comment|// CMYK jpegs are not supported by JAI, so that we have the conversion on our own
specifier|private
name|BufferedImage
name|readImage
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// pointer into the target array
name|int
name|rgbIndex
init|=
literal|0
