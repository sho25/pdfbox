...
name|job
decl_stmt|;
comment|/**      * Creates a {@link Pageable} adapter for the given PDF document and      * printer job.      *      * @param document PDF document      * @param job printer job      * @throws IllegalArgumentException if an argument is<code>null</code>      * @throws PrinterException if the document permissions prevent printing      */
specifier|public
name|PDPageable
parameter_list|(
name|PDDocument
