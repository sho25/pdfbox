...
return|;
block|}
comment|/**      * This will flatten all form fields.      *       *<p>Flattening a form field will take the current appearance and make that part      * of the pages content stream. All form fields and annotations associated are removed.</p>      *        * @throws IOException       */
specifier|public
name|void
name|flatten
parameter_list|()
