...
argument_list|>
argument_list|>
name|pagesWidgetsMap
init|=
name|buildPagesWidgetsMap
argument_list|(
name|fields
argument_list|)
decl_stmt|;
...
return|;
block|}
comment|/**      * Check if there needs to be a scaling transformation applied.      *       * @param annotation      * @param rotation       * @return the need for a scaling transformation.      */
specifier|private
name|boolean
name|resolveNeedsScaling
parameter_list|(
...
return|;
block|}
comment|// If there is a widget with a missing page reference we need to build the map reverse i.e.
comment|// from the annotations to the widget.
name|LOG
operator|.
name|warn
argument_list|(
literal|"There has been a widget with a missing page reference, will check all page annotations"
argument_list|)
expr_stmt|;
for|for
control|(
...
condition|)
block|{
comment|// if the field has no parent, assume it is at root level list, remove it from there
name|array
operator|=
operator|(
name|COSArray
...
block|{
comment|// if the field has a parent, then remove from the list there
name|array
operator|=
operator|(
name|COSArray
