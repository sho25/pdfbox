...
expr_stmt|;
block|}
comment|/**      * Returns true if this field is checked.      *       * @return True if checked      */
specifier|public
name|boolean
name|getValue
parameter_list|()
...
return|;
block|}
comment|/**      * Returns the default value, if any.      *      * @return True if checked, false if not checked, null if missing.      */
specifier|public
name|Boolean
...
return|;
block|}
comment|/**      * Sets the checked value of this field.      *      * @param value True if checked      * @throws IOException if the value could not be set      */
specifier|public
name|void
name|setValue
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Sets the default value.      *      * @param value True if checked      * @throws IOException if the value could not be set      */
specifier|public
name|void
