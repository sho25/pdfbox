...
return|;
block|}
comment|/**      * Set the destination OutputStream.      * @param destination      *            The destination to set.      */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * Add a list of sources to the list of documents to merge.      *      * @param source List of InputStream objects representing source documents      */
specifier|public
name|void
name|addSources
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|/**    *     * @param destination    * @param base    * @return    * @throws IOException    */
specifier|private
name|COSBase
name|cloneForNewDocument
parameter_list|(
...
return|;
block|}
comment|/**      * Deep clone and Merge from Base to Target.<br/>      * base and target must be instances of the same class.      * @param destination      * @param base      * @param target      * @throws IOException      */
specifier|private
name|void
name|cloneMerge
parameter_list|(
