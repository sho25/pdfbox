...
literal|false
decl_stmt|;
comment|/**      * This will add overlays to a documents.      *       * @param specificPageOverlayFile map of overlay files for specific pages      * @param useNonSeqParser indicates whether the non-sequential parser is used      * @throws IOException if something went wrong      */
specifier|public
name|void
name|overlay
parameter_list|(
