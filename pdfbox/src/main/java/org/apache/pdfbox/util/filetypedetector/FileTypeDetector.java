...
name|Exception
argument_list|(
literal|"Not intended for instantiation"
argument_list|)
throw|;
block|}
comment|/**      * Examines the a file's first bytes and estimates the file's type.      *<p>      * Requires a {@link BufferedInputStream} in order to mark and reset the stream to the position      * at which it was provided to this method once completed.      *<p>      * Requires the stream to contain at least eight bytes.      *      * @throws IOException if an IO error occurred or the input stream ended unexpectedly.      */
specifier|public
specifier|static
name|FileType
name|detectFileType
