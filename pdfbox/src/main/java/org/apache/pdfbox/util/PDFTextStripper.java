...
name|inParagraph
decl_stmt|;
comment|/**      * Instantiate a new PDFTextStripper object. Will not do      * anything special to convert the text to a more encoding-specific output.      *      * @throws IOException If there is an error loading the properties.      */
specifier|public
name|PDFTextStripper
parameter_list|()
throws|throws
...
expr_stmt|;
block|}
comment|/**      * Instantiate a new PDFTextStripper object. Will apply      * encoding-specific conversions to the output text.      *      * @param encoding The encoding that the output will be written in.      * @throws IOException If there is an error reading the properties.      */
specifier|public
name|PDFTextStripper
parameter_list|(
name|String
...
argument_list|()
decl_stmt|;
comment|// concatenate the pieces of text in opposite order if RTL is dominant
if|if
condition|(
name|isRtlDominant
condition|)
