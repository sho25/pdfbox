...
block|}
block|}
comment|/**      * Called when a single run of text with a spacing adjustment is to be shown.      *      * @param string the encoded text      * @param adjustment spacing adjustment to apply before showing the string      * @throws IOException if there was an error showing the text      */
specifier|protected
name|void
name|showAdjustedTextRun
parameter_list|(
