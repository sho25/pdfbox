...
begin_comment
comment|/**  * A PDF named object.  * @author Ben Litchfield  */
end_comment
...
literal|256
decl_stmt|;
comment|// Be more restrictive than the PDF spec, "Name Objects"
comment|// see PDFBOX-2073
if|if
condition|(
operator|(
name|current
...
block|}
block|}
comment|/**      * Not usually needed except if resources need to be reclaimed in a long running process. Patch provided by      * flester@GMail.com incorporated 5/23/08, Danielwilson@users.SourceForge.net      */
specifier|public
specifier|static
