...
argument_list|)
expr_stmt|;
comment|//		data.add(wrapProperty("BaseURL", "URL", "URL"));
name|data
operator|.
name|add
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//		data.add(wrapProperty("CreatorTool", "Text", "CreatorTool"));
name|data
operator|.
name|add
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// TODO TEST test Thumbnail when implemented in the XMPBasicSchema
name|data
operator|.
name|add
argument_list|(
