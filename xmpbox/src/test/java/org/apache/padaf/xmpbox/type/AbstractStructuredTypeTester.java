...
expr_stmt|;
block|}
comment|//	protected List<Field> getXmpFields () {
comment|//		Field [] fields = clz.getFields();
comment|//		List<Field> result = new ArrayList<Field>(fields.length);
comment|//		for (Field field : fields) {
comment|//			if (field.getAnnotation(PropertyType.class)!=null) {
comment|//				result.add(field);
comment|//			}
comment|//		}
