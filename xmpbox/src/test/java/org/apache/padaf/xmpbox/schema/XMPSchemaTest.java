...
argument_list|)
expr_stmt|;
comment|/* 		 * System.out.println("Bag Management :"); 		 * parent.getFuturOwner().appendChild(schem.getElement()); try { 		 * XMLUtil.save(parent.getFuturOwner(), System.out, "UTF-8"); } catch 		 * (TransformerException e) { 		 *  		 * e.printStackTrace(); } System.out.println("------------------"); 		 */
block|}
annotation|@
name|Test
specifier|public
...
expr_stmt|;
block|}
comment|/* 		 * System.out.println("Simple Properties Management :"); 		 * parent.getFuturOwner().appendChild(schem.getElement()); try { 		 * XMLUtil.save(parent.getFuturOwner(), System.out, "UTF-8"); } catch 		 * (TransformerException e) { 		 *  		 * e.printStackTrace(); } System.out.println("------------------"); 		 */
block|}
annotation|@
name|Test
specifier|public
...
argument_list|)
expr_stmt|;
comment|/* 		 * System.out.println("Alternatives lang Management :"); 		 * parent.getFuturOwner().appendChild(schem.getElement()); try { 		 * XMLUtil.save(parent.getFuturOwner(), System.out, "UTF-8"); } catch 		 * (TransformerException e) { 		 *  		 * e.printStackTrace(); } System.out.println("------------------"); 		 */
block|}
