...
expr_stmt|;
block|}
comment|// The Z format option prints the time zone in the format
comment|// +0100. Unfortunately this is not in line with the IDO8601 specification
comment|// the format is +01:00. We will insert the colon to the formatted date.
name|dateString
operator|.
name|insert
argument_list|(
