...
begin_comment
comment|/**  * Object representation of a Real XMP type  *   * @author a183132  *   */
end_comment
...
block|{
comment|/** 	 * Property Real type constructor (namespaceURI is not given) 	 *  	 * @param metadata 	 *            The metadata to attach to this property 	 * @param prefix 	 *            The prefix to set for this property 	 * @param propertyName 	 *            The local Name of this property 	 * @param value 	 *            The value to set 	 */
specifier|public
name|RealType
parameter_list|(
name|XMPMetadata
