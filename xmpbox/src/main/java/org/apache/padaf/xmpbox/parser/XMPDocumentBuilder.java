...
literal|"valueType"
decl_stmt|;
comment|/** 	 * RDF namespace constant 	 */
...
name|XmpPropertyFormatException
argument_list|(
literal|"Failed to create property"
argument_list|,
name|e
argument_list|)
throw|;
...
specifier|protected
name|void
name|parseStructuredPropertyArray
parameter_list|(
name|XMPMetadata
name|metadata
parameter_list|,
...
name|ctype
argument_list|,
literal|"Expected declaration of "
argument_list|,
name|ctype
argument_list|)
expr_stmt|;
...
argument_list|()
argument_list|,
literal|"Expected end of property "
argument_list|,
name|ctype
argument_list|)
expr_stmt|;
...
argument_list|()
decl_stmt|;
comment|// retrieve array type and content type
name|int
name|pos
init|=
name|type
