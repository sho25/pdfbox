...
name|println
argument_list|(
literal|"in method parse: prefix:"
operator|+
name|reader
operator|.
name|get
...
block|}
block|}
comment|/** 	 * Check if rdf:about attribute is declared for rdf description and add all 	 * attributes to the schema 	 *  	 * @param metadata 	 *            Metadata to attach new elements 	 * @param schema 	 *            Schema corresponding to the rdf:Description use 	 * @throws XmpExpectedRdfAboutAttribute 	 *             When rdf:Description not contains rdf:about attribute 	 */
specifier|private
name|void
