...
block|{
comment|/** 	 * Property Text type constructor (namespaceURI is not given) 	 *  	 * @param metadata 	 *            The metadata to attach to this property 	 * @param prefix 	 *            The prefix to set for this property 	 * @param propertyName 	 *            The local Name of this property 	 * @param value 	 *            The value to set 	 */
specifier|public
name|TextType
parameter_list|(
name|XMPMetadata
