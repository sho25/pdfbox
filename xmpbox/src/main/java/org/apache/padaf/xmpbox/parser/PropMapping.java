...
expr_stmt|;
block|}
comment|/** 	 * Give the NS URI associated to this Property Description 	 *  	 * @return the namespace URI concerned by this PropMapping 	 */
specifier|public
name|String
...
return|;
block|}
comment|/** 	 * Return an unmodifiable list of property attributes from its qualifiedName 	 *  	 * @param name 	 *            LocalName of the property 	 * @return List of all attributes declared for this property 	 */
specifier|public
name|List
argument_list|<
name|String
