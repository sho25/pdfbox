...
name|objValue
decl_stmt|;
comment|/** 	 * Property specific type constructor (namespaceURI is not given) 	 *  	 * @param metadata 	 *            The metadata to attach to this property 	 * @param prefix 	 *            The prefix to set for this property 	 * @param propertyName 	 *            The local Name of this property 	 * @param value 	 *            the value to give 	 *  	 */
specifier|public
name|AbstractSimpleProperty
parameter_list|(
name|XMPMetadata
...
expr_stmt|;
block|}
comment|/** 	 * Must be rewritten in each special XMP type Class to check if the value 	 * type corresponding to the XMP Type 	 *  	 * @param value 	 *            Object to analyze 	 * @return true if object type can be treat by the property type 	 */
specifier|public
specifier|abstract
name|boolean
name|isGoodType
