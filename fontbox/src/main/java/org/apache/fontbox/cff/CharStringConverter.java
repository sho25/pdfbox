...
literal|0
decl_stmt|;
comment|/**      * Constructor.      *       * @param defaultWidth default width      * @param nominalWidth nominal width      *       * @deprecated Use {@link CharStringConverter#CharStringConverter(int, int)} instead      */
specifier|public
name|CharStringConverter
parameter_list|(
name|int
...
parameter_list|,
name|IndexData
name|fontGlobalSubrIndex
parameter_list|,
name|IndexData
name|fontLocalSubrIndex
parameter_list|)
block|{
name|defaultWidthX
operator|=
