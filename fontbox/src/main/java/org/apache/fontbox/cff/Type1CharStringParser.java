...
literal|null
decl_stmt|;
comment|/**      * The given byte array will be parsed and converted to a Type1 sequence.      * @param bytes the given mapping as byte array      * @param localSubrIndex index containing all local subroutines      *       * @return the Type1 sequence      * @throws IOException if an error occurs during reading      */
specifier|public
name|List
argument_list|<
name|Object
