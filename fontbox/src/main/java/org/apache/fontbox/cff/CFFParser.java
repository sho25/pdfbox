...
condition|)
block|{
comment|// -- No specific behavior for this font
name|font
operator|=
operator|new
name|CFFFont
...
literal|null
condition|)
comment|// --- ROS uses StandardEncoding
block|{
name|encoding
operator|=
name|CFFStandardEncoding
...
condition|)
block|{
comment|// ---- It is a CIDKeyed Font, The Private Dictionary isn't in the Top Dict But in the Font Dict
comment|// ---- Font Dict can be accessed by the FDArray and FDSelect
name|DictData
operator|.
name|Entry
name|fdArrayEntry
...
argument_list|)
decl_stmt|;
comment|// --- Font DICT is invalid without "Private" entry
if|if
condition|(
name|privateEntry
operator|==
...
name|IOException
argument_list|(
literal|"Missing Private Dictionary"
argument_list|)
throw|;
block|}
name|int
...
condition|)
block|{
comment|//font.setLocalSubrIndex(new IndexData(0));
name|font
operator|.
name|addValueToPrivateDict
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//font.setLocalSubrIndex(readIndexData(input));
name|font
operator|.
name|addValueToPrivateDict
argument_list|(
...
block|{
comment|// last range reach, the sentinel must be greater than glyph
if|if
condition|(
name|sentinel
operator|>
...
argument_list|()
decl_stmt|;
comment|// ---- search the position of the given glyph
for|for
control|(
name|Mapping
name|mapping
...
name|List
argument_list|<
name|CharMetricSortable
argument_list|>
name|metrics
init|=
name|createCharMetrics
argument_list|(
name|font
argument_list|)
decl_stmt|;
