...
condition|)
block|{
comment|// PDFBOX-4489: catch corrupt file
comment|// https://docs.microsoft.com/en-us/typography/opentype/spec/chapter2#slTbl_sRec
name|LOG
operator|.
name|error
argument_list|(
literal|"LangSysRecords not alphabetically sorted by LangSys tag: "
operator|+
name|langSysTags
index|[
name|i
