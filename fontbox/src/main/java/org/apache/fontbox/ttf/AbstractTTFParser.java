...
expr_stmt|;
block|}
comment|/**      * Constructor.      *       * @param fontIsEmbedded indicates whether the font is embedded or not.      * @param parseOnDemand indicates whether the tables of the font should be parsed on demand only or not.      */
specifier|public
name|AbstractTTFParser
parameter_list|(
name|boolean
