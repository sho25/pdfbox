...
return|;
block|}
comment|/**      * Returns the character code for the given GID, or null if there is none.      *      * @param gid glyph id      * @return character code      *       * @deprecated the mapping may be ambiguous. The first mapped value is returned by default.      */
specifier|public
name|Integer
