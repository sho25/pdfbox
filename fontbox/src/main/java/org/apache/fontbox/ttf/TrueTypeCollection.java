...
return|;
block|}
comment|/**      * Return a TrueType font by name.      *      * @param fontName the font name to search for.      * @return the found font or null if no font for that name was found.      * @throws IOException if there was an error reading the naming table of a font.      */
specifier|public
name|TrueTypeFont
name|getFontByName
parameter_list|(
