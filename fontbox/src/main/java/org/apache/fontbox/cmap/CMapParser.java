...
block|{
comment|// PDFBOX-4720:
comment|// some pdfs use the malformed bfrange<0000><FFFF><0000>. Add support by adding a identity
comment|// mapping for the whole range instead of cutting it after 255 entries
comment|// TODO find a more efficient method to represent all values for a identity mapping
if|if
condition|(
name|tokenBytes
operator|.
