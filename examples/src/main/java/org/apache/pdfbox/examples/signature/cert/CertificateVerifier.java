...
block|}
block|}
comment|/**      * Download extra certificates from the URI mentioned in id-ad-caIssuers in the "authority      * information access" extension. These are added to the store and the possibly updated store is      * returned. The method is lenient, i.e. catches all exceptions.      *      * @param ext an X509 object that can have extensions.      * @param certificatesStore      * @return the updated certificates store.      */
specifier|public
specifier|static
name|Store
argument_list|<
...
parameter_list|)
block|{
comment|// should not happen because the certificates already exist
name|LOG
operator|.
name|warn
argument_list|(
