...
argument_list|)
expr_stmt|;
comment|// PDF specification about word spacing:
comment|// "Word spacing shall be applied to every occurrence of the single-byte character
comment|// code 32 in a string when using a simple font or a composite font that defines
comment|// code 32 as a single-byte code. It shall not apply to occurrences of the byte
comment|// value 32 in multiple-byte codes.
comment|// TrueType font with no word spacing
name|contentStream
operator|.
name|setTextMatrix
argument_list|(
...
literal|1000
decl_stmt|;
comment|// TrueType font with word spacing
name|contentStream
operator|.
name|setTextMatrix
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Type0 font with word spacing that has no effect
name|contentStream
operator|.
name|setTextMatrix
argument_list|(
