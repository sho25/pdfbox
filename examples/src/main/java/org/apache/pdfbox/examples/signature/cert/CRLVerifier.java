...
name|info
argument_list|(
literal|"CRL issuer certificate is not identical to cert issuer, check needed"
argument_list|)
expr_stmt|;
name|CertificateVerifier
operator|.
...
name|info
argument_list|(
literal|"CRL issuer certificate checked successfully"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|info
argument_list|(
literal|"CRL issuer certificate is identical to cert issuer, no extra check needed"
argument_list|)
expr_stmt|;
block|}
