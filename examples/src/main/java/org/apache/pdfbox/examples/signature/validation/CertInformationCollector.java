...
name|rootCertInfo
decl_stmt|;
comment|/**      * Gets the Certificate Information of the last Signature.      *       * @param document to get the Signature from      * @param fileName of the document.      * @return the CertSignatureInformation containing all certificate information      * @throws CertificateProccessingException when there is an error processing the certificates      * @throws IOException on a data processing error      */
specifier|public
name|CertSignatureInformation
