...
expr_stmt|;
block|}
comment|/**      * Sign pdf file and create new file that ends with "_signed.pdf".      *      * @param documentFile The source pdf document file.      * @param signatureProperties The signature properties.      * @return the signed pdf document file.      * @throws IOException      */
specifier|public
name|File
name|signPDF
parameter_list|(
