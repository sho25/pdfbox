...
name|signature
decl_stmt|;
comment|// You will usually not need this:
comment|// sign a PDF with an existing empty signature, as created by the
comment|// CreateEmptySignatureForm example. Delete this line if you want to insert a new signature.
name|signature
operator|=
...
block|{
comment|//TODO add your error handling here:
comment|// it doesn't make sense to replace an existing signature
block|}
comment|// position according to existing field widget
name|PDAnnotationWidget
name|widget
init|=
name|signatureField
...
argument_list|()
decl_stmt|;
comment|// need to substract from height because this is done later too
comment|// see in PDVisibleSigBuilder.createSignatureRectangle()
name|visibleSignDesigner
operator|.
name|xAxis
argument_list|(
