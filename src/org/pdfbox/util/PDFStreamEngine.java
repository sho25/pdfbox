...
block|}
comment|/**      * You should override this method if you want to perform an action when a      * string is being shown.      *      * @param string The string to display.      *      * @throws IOException If there is an error showing the string      */
specifier|public
name|void
name|showString
parameter_list|(
...
decl_stmt|;
name|float
name|characterHorizontalDisplacement
init|=
literal|0
decl_stmt|;
name|float
name|characterVerticalDisplacement
init|=
literal|0
decl_stmt|;
name|float
name|spaceDisplacement
init|=
literal|0
decl_stmt|;
name|float
...
name|horizontalScaling
decl_stmt|;
comment|//not sure if this is right but what else to do???
name|float
name|rise
init|=
name|graphicsState
...
expr_stmt|;
block|}
comment|// We want to update the textMatrix using the width, in text space units.
comment|//
...
literal|0
decl_stmt|;
comment|//todo, need to compute the vertical displacement
name|float
name|ty
init|=
literal|0
