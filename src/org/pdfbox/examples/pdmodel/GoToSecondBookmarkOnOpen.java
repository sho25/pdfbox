...
begin_comment
comment|/**  * This is an example on how to an action to go to the second page when the PDF is opened.  *  * Usage: java org.pdfbox.examples.pdmodel.GoToSecondPageOnOpen&lt;input-pdf&gt;&lt;output-pdf&gt;  *  * @author<a href="mailto:ben@benlitchfield.com">Ben Litchfield</a>  * @version $Revision: 1.3 $  */
end_comment
...
name|println
argument_list|(
literal|"Usage: java org.pdfbox.examples.pdmodel.GoToSecondBookmarkOnOpen<input-pdf><output-pdf>"
argument_list|)
expr_stmt|;
block|}
block|}
