...
comment|//protected PushBackByteArrayStream pdfSource;
specifier|protected
name|PushBackInputStream
name|pdfSource
decl_stmt|;
comment|/**      * moved xref here, is a persistence construct      * maybe not needed anyway when not read from behind with delayed      * access to objects.      */
specifier|private
name|List
name|xrefs
init|=
...
literal|0
decl_stmt|;
comment|//this is the additional bytes buffered but not written
name|int
...
expr_stmt|;
block|}
comment|/**      * This basically checks to see if the next compareTo.length bytes of the      * buffer match the compareTo byte array.      */
specifier|private
name|boolean
name|cmpCircularBuffer
parameter_list|(
...
return|;
block|}
comment|/**      * This will read bytes until the end of line marker occurs.      *      * @return The characters between the current position and the end of the line.      *      * @throws IOException If there is an error reading from the stream.      */
specifier|protected
name|String
name|readLine
parameter_list|()
...
return|;
block|}
comment|/**      * This will add an xref.      *      * @param xref The xref to add.      */
specifier|public
name|void
name|addXref
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * This will get all of the xrefs.      *      * @return A list of all xrefs.      */
specifier|public
name|List
name|getXrefs
parameter_list|()
