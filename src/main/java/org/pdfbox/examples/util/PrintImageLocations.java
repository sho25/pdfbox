...
begin_comment
comment|/**  * This is an example on how to get the x/y coordinates of image locations.  *  * Usage: java org.pdfbox.examples.util.PrintImageLocations&lt;input-pdf&gt;  *  * @author<a href="mailto:ben@benlitchfield.com">Ben Litchfield</a>  * @version $Revision: 1.5 $  */
end_comment
...
name|println
argument_list|(
literal|"Usage: java org.pdfbox.examples.pdmodel.PrintImageLocations<input-pdf>"
argument_list|)
expr_stmt|;
block|}
block|}
