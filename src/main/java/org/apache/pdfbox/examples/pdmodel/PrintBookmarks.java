...
begin_comment
comment|/**  * This is an example on how to access the bookmarks that are part of a pdf document.  *  * Usage: java org.apache.pdfbox.examples.pdmodel.PrintBookmarks&lt;input-pdf&gt;  *  * @author<a href="mailto:ben@benlitchfield.com">Ben Litchfield</a>  * @version $Revision: 1.2 $  */
end_comment
