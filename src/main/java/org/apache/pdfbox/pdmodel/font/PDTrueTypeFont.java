...
block|{
comment|//throw new IOException( "Error:TTF Stream is null");
comment|// Embedded true type programs are optional,
comment|// if there is no stream, we must use an external
comment|// file.
name|TrueTypeFont
name|ttf
init|=
