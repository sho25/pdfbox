...
condition|)
block|{
comment|//from Sector9 ... believed but not proven to be right.
name|int
index|[]
name|nbBits
init|=
...
block|{
comment|//Daniel Wilson's implementation with some guidance from Jeremias
if|if
condition|(
name|bpc
operator|==
...
name|IOException
argument_list|(
literal|"Unsure how to create a Color Model for "
operator|+
name|bpc
operator|+
literal|" bits per component"
argument_list|)
throw|;
block|}
block|}
