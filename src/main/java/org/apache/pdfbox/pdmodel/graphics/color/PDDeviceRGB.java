...
begin_comment
comment|/**  * This class represents an RGB color space.  *  * @author<a href="mailto:ben@benlitchfield.com">Ben Litchfield</a>  * @version $Revision: 1.8 $  */
end_comment
...
argument_list|()
decl_stmt|;
comment|/**      * This class is immutable.      */
specifier|private
name|PDDeviceRGB
parameter_list|()
block|{
comment|//only here to make immutable.
block|}
