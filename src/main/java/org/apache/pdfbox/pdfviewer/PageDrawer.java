...
argument_list|()
decl_stmt|;
comment|// If there is a rotation, we have to add a additional rotation by 180°.
comment|// Don't no why.yet. I guess there is a problem with clockwise- and counterclockwise-rotation
if|if
condition|(
name|at
operator|.
