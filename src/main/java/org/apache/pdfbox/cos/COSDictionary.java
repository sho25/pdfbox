...
literal|"/"
decl_stmt|;
comment|/**      * These are all of the items in the dictionary.      */
specifier|private
name|Map
name|items
init|=
...
argument_list|()
decl_stmt|;
comment|/**      * Used to store original sequence of keys, for testing.      */
specifier|private
name|List
name|keys
init|=
...
condition|)
block|{
comment|// insert only if not already there
name|keys
operator|.
name|add
argument_list|(
...
return|;
block|}
comment|/**      * This is a convenience method that will get the dictionary object that      * is expected to be an int.  -1 is returned if there is no value.      *      * @param key The key to the item in the dictionary.      * @return The float value.      */
specifier|public
name|float
name|getFloat
parameter_list|(
...
return|;
block|}
comment|/**      * This will get the keys for all objects in the dictionary in the sequence that      * they were added.      *      * @return a list of the keys in the sequence of insertion      *      */
specifier|public
name|List
name|keyList
parameter_list|()
...
return|;
block|}
comment|/**      * visitor pattern double dispatch method.      *      * @param visitor The object to notify when visiting this object.      * @return The object that the visitor returns.      *      * @throws COSVisitorException If there is an error visiting this object.      */
specifier|public
name|Object
name|accept
parameter_list|(
...
return|;
block|}
comment|/* 	Don't just tell me it's a dictionary -- tell me its contents!     */
specifier|public
name|String
name|toString
parameter_list|()
