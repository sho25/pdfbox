...
argument_list|()
decl_stmt|;
comment|// If the pdf is printed, sometimes a NPE occurs, see PDFBOX-552 for details
comment|// As a workaround we have to replace a possible null-value with a rectangle having
comment|// the same dimension than the page to be printed
if|if
condition|(
name|clip
operator|==
