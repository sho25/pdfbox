...
parameter_list|)
block|{
comment|// get the center of the rectangle being tested
name|double
name|xcenter
init|=
name|tp2
...
name|ydelta
decl_stmt|;
comment|// If the x-coordinate of tp2's center is within this obj's x-coordinates
comment|// and the y-coordinate of tp2's center is in this obj's rectangle expanded
comment|// by ydelta, then at least 50% (with respect to the x-direction) of tp2
comment|// is within this obj
if|if
condition|(
operator|(
name|xcenter
...
control|)
block|{
comment|// The diacritic modifies this character.
if|if
condition|(
name|xdiac
operator|>=
